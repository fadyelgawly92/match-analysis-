...
analytics_dataframe = pd.DataFrame(columns = ['id', 'color', 'x' , 'y'])

def excel_analytics_dataframe():
    global analytics_dataframe
    analytics_dataframe.to_csv('analytics.csv')

def appned_to_analytics_dataframe(id,color_name,x,y):
    global analytics_dataframe
    # append rows to an empty DataFrame
    analytics_dataframe = analytics_dataframe.append({'id' : id, 'color' : color_name, 'x' : x, 'y':y},
        ignore_index = True) 
...
def plot_one_box(x, img, name , id ,color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        if name == 'person':
            ...
            if hue_value < 5:
                ...
                color = (51,0,102) # VIOLET
                color_name = 'VIOLET'
            else:
                color = (0,0,0) # BLACK
                color_name = 'BLACK'
            appned_to_analytics_dataframe(id,color_name,cx,cy)
